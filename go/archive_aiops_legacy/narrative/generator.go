...
func (g *NarrativeGenerator) GenerateOOMNarrative(ctx context.Context, event collector.OOMEvent, result *analyzer.AnalysisResult) (string, error) {
...
func (g *NarrativeGenerator) buildOOMPrompt(event collector.OOMEvent, result *analyzer.AnalysisResult) string {
	return fmt.Sprintf(
