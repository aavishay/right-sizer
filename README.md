...
helm install right-sizer right-sizer/right-sizer --version 0.1.15

# Or install from OCI registry
helm install right-sizer oci://registry-1.docker.io/aavishay/right-sizer --version 0.1.15
```
...
docker pull aavishay/right-sizer:0.1.15
...
helm repo update
helm upgrade right-sizer right-sizer/right-sizer --version 0.1.15
